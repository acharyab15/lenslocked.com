...
//
// For singler user queries, any error but ErrNotFound
// should probably result in a 500 error until we make
...
// UserDB in our interfaces chain.
...
func (uv *userValidator) emailIsAvail(user *User) error {
	...
	// address, so we need to see if this is the same user we are
	// updating, or if we have a conflict.
